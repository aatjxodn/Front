		...
		<div class="signUp1_con">
			...
			<div class="signUp2_smsTable">
				<table>
					<tr>
						<th>성명</th>
						<td><input type="text" placeholder="성명을 입력하세요."></th>
					</tr>
					<tr>
						<th>휴대폰번호</th>
						<td><input type="text" placeholder="휴대폰 번호를 입력하세요."><input type="button" value="인증번호 발송"></th>
						<th>인증번호</th>
						<td><input type="text" placeholder="인증번호를 입력하세요."><input type="button" value="확인"></th>
